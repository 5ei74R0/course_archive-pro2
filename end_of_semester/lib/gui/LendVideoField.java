...
public class LendVideoField {
    public LendVideoField(JTextArea referenceToResultField, VideoArchive referenceToVideoArchive,
            MembersList referenceToMembers) {
        this.pane = new JPanel();
        this.subPane = new JPanel();
        this.fieldTitle = new JLabel("Lend the Video");
        ...
        button.addActionListener((e) -> {
            String resultStatus = "Lend the video...\n\n";
            ...
            try {
                ...
                videoArchive.lendVideo(inputUserId, inputTitle, num);
                member.borrowVideo(inputTitle, num);
                Video video = videoArchive.getVideo(inputTitle);
                resultStatus += "\t The operation has been completed successfully.\n\n";
                resultStatus += "\t < Information of the lent video >\n";
